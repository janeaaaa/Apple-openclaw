...
description: >
  ...
  Supports both Node.js and Python CLI tools. Use when asked to humanize text,
  de-AI writing, make content sound more natural/human, review writing for AI
  patterns, score text for AI detection, or improve AI-generated drafts. Covers
...
## Python CLI Tools (Additional)

This skill also includes Python-based CLI tools for advanced detection and transformation:
...
### patterns.json — Customizable Patterns
...
```bash
# Score text
echo "Your text" | node src/cli.js score
...
```bash
# Detect patterns
python scripts/detect.py document.txt -v
